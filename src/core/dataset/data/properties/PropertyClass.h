 ...
 */
 class OVITO_CORE_EXPORT PropertyClass : public DataObject::OOMetaClass 
{
public:
...
Q_DECLARE_METATYPE(Ovito::PropertyClassPtr);
Q_DECLARE_TYPEINFO(Ovito::PropertyClassPtr, Q_PRIMITIVE_TYPE);
