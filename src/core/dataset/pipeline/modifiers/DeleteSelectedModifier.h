 ...
 */
class OVITO_CORE_EXPORT DeleteSelectedModifierDelegate : public ModifierDelegate
{
 ...
 */
class OVITO_CORE_EXPORT DeleteSelectedModifier : public MultiDelegatingModifier
{
