 ...
 */
class OVITO_CORE_EXPORT ScatterPlotModifier : public GenericPropertyModifier
{
	Q_OBJECT
 ...
 */
 class OVITO_CORE_EXPORT ScatterPlotModifierApplication : public ModifierApplication
 {		
