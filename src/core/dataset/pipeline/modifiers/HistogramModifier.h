 ...
 */
class OVITO_CORE_EXPORT HistogramModifier : public GenericPropertyModifier
{
	Q_OBJECT
 ...
 */
class OVITO_CORE_EXPORT HistogramModifierApplication : public ModifierApplication
{
