...
public:
	...
	enum Type {
		...
		/// This event is generated by a PipelineObject or by an ObjectNode if the structure of the 
		/// upstream pipeline changes.
		PipelineChanged,

		/// This event is generated by a PipelineObject or by an ObjectNode if a new preliminary state
