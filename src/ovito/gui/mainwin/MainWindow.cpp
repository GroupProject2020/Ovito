...
#include <ovito/gui/widgets/animation/AnimationTimeSpinner.h>
#include <ovito/gui/widgets/animation/AnimationFramesToolButton.h>
#include <ovito/gui/widgets/animation/AnimationTimeSlider.h>
#include <ovito/gui/widgets/animation/AnimationTrackBar.h>
#include <ovito/gui/widgets/rendering/FrameBufferWindow.h>
#include <ovito/gui/widgets/display/CoordinateDisplayWidget.h>
...
* given data source.
******************************************************************************/
bool MainWindow::openDataInspector(PipelineObject* dataSource, const QString& objectNameHint)
{
	if(_dataInspector->selectDataObject(dataSource, objectNameHint)) {
		_dataInspector->open();
		return true;
	}
	return false;
