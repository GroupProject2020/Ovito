...
PYBIND11_MODULE(ParticlesPython, m)
{
	...
	auto Bonds_py = ovito_class<BondsObject, PropertyContainer>(m,
		":Base class: :py:class:`ovito.data.PropertyContainer`"
		"\n\n"
    	"Stores the list of bonds and their properties. A :py:class:`!Bonds` object is always part of a parent :py:class:`~ovito.data.Particles` object. "
		...
		"\n\n"
		"============================= ======================== ========== =======================\n"
		"Property name                 Python attribute         Data type  Component names\n"
		"============================= ======================== ========== =======================\n"
		...
		":guilabel:`Topology`          :py:attr:`topology`      int64      A, B\n"
		":guilabel:`Transparency`                               float       \n"
		"============================= ======================== ========== =======================\n"
		// Python class name:
		,"Bonds")
	...
	ovito_class<BondType, ElementType>{m,
			":Base class: :py:class:`ovito.data.ElementType`"
			"\n\n"
			"Represents a bond type. This class inherits all its fields from the :py:class:`~ovito.data.ElementType` base class. "
			"\n\n"
			"You can enumerate the list of defined bond types by accessing the :py:attr:`bond_types <ovito.data.Bonds.bond_types>` bond property object: "
			"\n\n"
			".. literalinclude:: ../example_snippets/bond_types.py\n"
			"   :lines: 8-10\n"}
	;
