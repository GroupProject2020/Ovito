...
/**
 * Used by the CreateIsosurfaceModifier to store the visualization element for the generated surface.
 */
class OVITO_GRID_EXPORT CreateIsosurfaceModifierApplication : public AsynchronousModifierApplication
{
	OVITO_CLASS(CreateIsosurfaceModifierApplication)
	Q_OBJECT

public:

	/// Constructor.
	Q_INVOKABLE CreateIsosurfaceModifierApplication(DataSet* dataset) : AsynchronousModifierApplication(dataset) {
