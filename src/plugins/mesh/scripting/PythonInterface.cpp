...
PYBIND11_PLUGIN(Mesh)
{
	...
	ovito_class<SurfaceMesh, PeriodicDomainDataObject>(m,
			...
			"\n\n"
			"The visual appearance of the surface mesh in rendered images is controlled by its attached :py:class:`~ovito.vis.SurfaceMeshDisplay` instance, which is "
			"accessible through the :py:attr:`~DataObject.display` base class attribute. "
			"\n\n"
	...
	ovito_class<SurfaceMeshDisplay, DisplayObject>(m,
			...
			"Controls the visual appearance of a surface mesh object, which can be generated by modifiers such as "
