...
IMPLEMENT_OVITO_CLASS(TriMeshDisplay);
DEFINE_PROPERTY_FIELD(TriMeshDisplay, color);
DEFINE_REFERENCE_FIELD(TriMeshDisplay, transparencyController);
...
******************************************************************************/
Box3 TriMeshDisplay::boundingBox(TimePoint time, DataObject* dataObject, ObjectNode* contextNode, const PipelineFlowState& flowState, TimeInterval& validityInterval)
{
