...
#include <plugins/galamost/GALAMOSTImporter.h>
...
PYBIND11_MODULE(GalamostPython, m)
{
	...
	ovito_class<GALAMOSTImporter, ParticleImporter>{m}
	;
}

OVITO_REGISTER_PLUGIN_PYTHON_INTERFACE(GalamostPython);
