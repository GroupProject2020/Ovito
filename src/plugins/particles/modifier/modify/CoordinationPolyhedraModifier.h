...
/**
 * Used by the CoordinationPolyhedraModifier to store the visualization element for the generated polyhedra.
 */
class OVITO_PARTICLES_EXPORT CoordinationPolyhedraModifierApplication : public AsynchronousModifierApplication
{
	OVITO_CLASS(CoordinationPolyhedraModifierApplication)
	Q_OBJECT

public:

	/// Constructor.
	Q_INVOKABLE CoordinationPolyhedraModifierApplication(DataSet* dataset) : AsynchronousModifierApplication(dataset) {
