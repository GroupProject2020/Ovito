...
/**
 * Used by the VoronoiAnalysisModifier to store the visualization element for the generated bonds.
 */
class OVITO_PARTICLES_EXPORT VoronoiAnalysisModifierApplication : public AsynchronousModifierApplication
{
	OVITO_CLASS(VoronoiAnalysisModifierApplication)
	Q_OBJECT

public:

	/// Constructor.
	Q_INVOKABLE VoronoiAnalysisModifierApplication(DataSet* dataset) : AsynchronousModifierApplication(dataset) {
