...
#include "BondPropertyEditor.h"
#include "BondTypeEditor.h"

namespace Ovito { namespace Particles { OVITO_BEGIN_INLINE_NAMESPACE(Internal)

IMPLEMENT_OVITO_CLASS(BondPropertyEditor);
SET_OVITO_OBJECT_EDITOR(BondProperty, BondPropertyEditor);

/******************************************************************************
* Sets up the UI widgets of the editor.
******************************************************************************/
void BondPropertyEditor::createUI(const RolloutInsertionParameters& rolloutParams)
{
	// Create a rollout.
	...
	public:
		CustomRefTargetListParameterUI(PropertiesEditor* parentEditor, const PropertyFieldDescriptor& refField, const RolloutInsertionParameters& rolloutParams)
			: RefTargetListParameterUI(parentEditor, refField, rolloutParams, &BondTypeEditor::OOClass()) {}
	protected:
	...
	RefTargetListParameterUI* bondTypesListUI = new CustomRefTargetListParameterUI(this, PROPERTY_FIELD(BondProperty::elementTypes), RolloutInsertionParameters().insertInto(subEditorContainer));
