...
/**
 * \brief Delegate for the ReplicateModifier that operates on microstructure data objects.
 */
class MicrostructureReplicateModifierDelegate : public ReplicateModifierDelegate
{
	...
	public:
		...
		virtual QString pythonDataName() const override { return QStringLiteral("microstructure"); }
	};

	Q_OBJECT
	OVITO_CLASS_META(MicrostructureReplicateModifierDelegate, OOMetaClass)
...
public:
	...
	/// Constructor.
	Q_INVOKABLE MicrostructureReplicateModifierDelegate(DataSet* dataset) : ReplicateModifierDelegate(dataset) {}
