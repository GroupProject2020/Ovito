...
/**
 * Used by the ConstructSurfaceModifier to store the visualization element for the generated surface.
 */
class OVITO_GRID_EXPORT ConstructSurfaceModifierApplication : public AsynchronousModifierApplication
{
	OVITO_CLASS(ConstructSurfaceModifierApplication)
	Q_OBJECT

public:

	/// Constructor.
	Q_INVOKABLE ConstructSurfaceModifierApplication(DataSet* dataset) : AsynchronousModifierApplication(dataset) {
