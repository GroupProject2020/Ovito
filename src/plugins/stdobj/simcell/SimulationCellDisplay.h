 ...
 */
class OVITO_STDOBJ_EXPORT SimulationCellDisplay : public DisplayObject
{
	Q_OBJECT
	OVITO_CLASS(SimulationCellDisplay)
...
protected:
	...
	void renderWireframe(TimePoint time, SimulationCellObject* cell, const PipelineFlowState& flowState, SceneRenderer* renderer, ObjectNode* contextNode);

	/// Renders the given simulation using solid shading mode.
	void renderSolid(TimePoint time, SimulationCellObject* cell, const PipelineFlowState& flowState, SceneRenderer* renderer, ObjectNode* contextNode);
