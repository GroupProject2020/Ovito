...
IMPLEMENT_OVITO_CLASS(SimulationCellDisplay);
DEFINE_PROPERTY_FIELD(SimulationCellDisplay, cellLineWidth);
DEFINE_PROPERTY_FIELD(SimulationCellDisplay, renderCellEnabled);
DEFINE_PROPERTY_FIELD(SimulationCellDisplay, cellColor);
...
******************************************************************************/
Box3 SimulationCellDisplay::boundingBox(TimePoint time, DataObject* dataObject, ObjectNode* contextNode, const PipelineFlowState& flowState, TimeInterval& validityInterval)
{
...
******************************************************************************/
void SimulationCellDisplay::renderWireframe(TimePoint time, SimulationCellObject* cell, const PipelineFlowState& flowState, SceneRenderer* renderer, ObjectNode* contextNode)
{
...
******************************************************************************/
void SimulationCellDisplay::renderSolid(TimePoint time, SimulationCellObject* cell, const PipelineFlowState& flowState, SceneRenderer* renderer, ObjectNode* contextNode)
{
	if(!renderer->isBoundingBoxPass()) {
