...
PYBIND11_MODULE(StdObj, m)
{
	...
	auto DataSeries_py = ovito_class<DataSeriesObject, DataObject>(m,
			":Base class: :py:class:`ovito.data.DataObject`\n\n"
			...
			"the :py:class:`~ovito.modifiers.CoordinationAnalysisModifier` and the :py:class:`~ovito.modifiers.HistogramModifier`. "
			"\n\n",
			// Python class name:
			"DataSeries")
